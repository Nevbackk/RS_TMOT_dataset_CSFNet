...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--model_name', default='ResFPN',
        ...
        self.parser.add_argument('--num_classes', type=int, default=path_config.NUM_CLASSES,
                                 help='number of object classes')
        # system
        self.parser.add_argument('--gpus', default=path_config.GPUS,
                                 help='-1 for CPU, use comma for multiple gpus')
        self.parser.add_argument('--num_workers', type=int, default=path_config.NUM_WORKERS,
                                 help='dataloader threads. 0 for single-thread.')
        self.parser.add_argument('--seed', type=int, default=317,
                                 help='random seed')  # from CornerNet

        # train
        self.parser.add_argument('--lr', type=float, default=path_config.LR,
                                 help='learning rate for batch size 4.')
        self.parser.add_argument('--lr_step', type=str, default='14',
                                 help='drop learning rate by 10.')
        self.parser.add_argument('--num_epochs', type=int, default=path_config.NUM_EPOCHS,
                                 help='total training epochs.')
        self.parser.add_argument('--batch_size', type=int, default=path_config.BATCH_SIZE,
                                 help='batch size')
        self.parser.add_argument('--val_intervals', type=int, default=100,
                                 help='number of epochs to run validation.')
        self.parser.add_argument('--seqLen', type=int, default=path_config.SEQ_LEN,
                                 help='number of images for per sample. Currently supports 5.')

        # test
        self.parser.add_argument('--nms', action='store_true',
                                 help='run nms in testing.')
        self.parser.add_argument('--K', type=int, default=path_config.K,
        ...
        self.parser.add_argument('--datasetname', type=str, default='ICPR_caronly',
                                 help='dataset name.')
        self.parser.add_argument('--data_dir', type=str, default=path_config.DATA_ROOT,
    ...
    def parse(self, args=''):
        ...
        # 避免 data_dir 分割错误，直接用固定名称
        opt.dataName = 'ICPR_caronly'
